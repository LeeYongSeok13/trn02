$(function () {
    ...
    $('#utb').YTPlayer({ videoURL: 'https://www.youtube.com/watch?v=dS9x5Ws67wI', containment: '.utb', autoPlay: true, mute: true, startAt: 0, opacity: 1, showControls: false, playOnlyIfVisible: true, });
